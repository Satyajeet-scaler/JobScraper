CREATE TABLE IF NOT EXISTS jobs (
    ...
    job_url_normalized VARCHAR(1024) NOT NULL,
    title VARCHAR(512) NULL,
    company VARCHAR(255) NULL,
    location VARCHAR(255) NULL,
    date_posted VARCHAR(120) NULL,
    requested_role VARCHAR(160) NULL,
...
CREATE TABLE IF NOT EXISTS job_recruiter_contacts (
    ...
    recruiter_profile_url_normalized VARCHAR(1024) NULL,
    recruiter_email VARCHAR(1024) NULL,
    recruiter_source VARCHAR(120) NULL,
